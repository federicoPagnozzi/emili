...
emili::TabuMemory* prs::irp::IrpParser::tmemory(emili::pfsp::PfspNeighborhood* n,prs::TokenManager& tm)
{
    prs::incrementTabLevel();
...
bool prs::irp::IrpParser::isParsable(string &problem)
{
    /*your parser can support more than one problem definition, extend this if/else to insert
      them*/
    if(strcmp(problem.c_str(),""/*TODO INSERT YOUR PROBLEM DEFINITION HERE*/)==0)
    {
